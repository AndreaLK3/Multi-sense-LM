...
def get_vocabulary_df(senselabeled_or_text, slc_split_name, corpus_txt_fpaths, out_vocabulary_h5_filepath, min_count):
    if os.path.exists(out_vocabulary_h5_filepath):
        ...
        vocabulary_h5.close()
        logging.info("*** The vocabulary was created from the " + slc_split_name + " split of the corpus ")
