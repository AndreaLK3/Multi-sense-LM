...
def create_phrases_model(corpus_txt_filepath):
    ...
    for i, line in enumerate(open(corpus_txt_filepath, "r", encoding="utf-8")):
        ...
        total_num_tokens = total_num_tokens + len(nltk.tokenize.word_tokenize(line))
        all_docsentences.extend(line_sentences)
        if i%10000 == 0 and i !=0:
            logging.info("Phrases: reading in corpus... line n." + str(i))


    min_freq = total_num_tokens // 10000
    phrases_score_threshold = min_freq * 1.5
