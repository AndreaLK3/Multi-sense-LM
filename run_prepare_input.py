...
graph_dataobj = DG.get_graph_dataobject(new=True, vocabulary_sources_ls=[F.WT2, F.SEMCOR], sp_method=Utils.SpMethod.FASTTEXT).to(Utils.DEVICE)
graph_folder, _, _ = F.get_folders_graph_input_vocabulary([F.WT2, F.SEMCOR], sp_method=Utils.SpMethod.FASTTEXT)
