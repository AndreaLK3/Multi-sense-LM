...
model, train_dataloader, valid_dataloader = T.setup_train(slc_or_text_corpus=True, include_globalnode_input=0,
                                                          load_saved_model=False,method=CE.Method.FASTTEXT,
                                                          grapharea_size=32, batch_size=3, sequence_length=4, K=1)
