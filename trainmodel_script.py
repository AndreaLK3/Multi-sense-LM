...
model, train_dataloader, valid_dataloader = T.training_setup(slc_or_text_corpus=True, include_senses_input = False, predict_senses=True, method=CE.Method.FASTTEXT, grapharea_size=32,batch_size=4, sequence_length=8);
