...
model, train_dataloader, valid_dataloader = T.setup_train(slc_or_text_corpus=True, include_globalnode_input=False, predict_senses=False, load_saved_model=False, method=CE.Method.FASTTEXT, grapharea_size=32, batch_size=40, sequence_length=35)
T.run_train(model, 0.0001, train_dataloader, valid_dataloader, 50, with_freezing=False)
