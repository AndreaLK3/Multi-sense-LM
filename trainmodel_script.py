...
#
# DG.get_graph_dataobject(new=True, method=CE.Method.FASTTEXT, slc_corpus=)
...
model, train_dataloader, valid_dataloader = T.training_setup(slc_or_text_corpus=False, include_globalnode_input=False, include_sensenode_input=False, predict_senses=False, method=CE.Method.FASTTEXT, grapharea_size=32,batch_size=4, sequence_length=8);
