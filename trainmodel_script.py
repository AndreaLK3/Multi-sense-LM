import WordEmbeddings.ComputeEmbeddings as CE;import GNN.Training as T;import CreateGraphInput as CGI;import Graph.DefineGraph as DG
...
model, train_dataloader, valid_dataloader = T.training_setup(slc_or_text_corpus=True, include_globalnode_input=False, include_sensenode_input=False, predict_senses=False, method=CE.Method.FASTTEXT, grapharea_size=32,batch_size=40, sequence_length=35)
T.training_loop(model, 0.0001, train_dataloader, valid_dataloader, 50, with_freezing=False);
