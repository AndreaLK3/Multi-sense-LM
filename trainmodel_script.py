...
model, train_dataloader, valid_dataloader = T.training_setup(slc_or_text_corpus=True, include_globalnode_input=False, include_sensenode_input=False, predict_senses=True, method=CE.Method.FASTTEXT, grapharea_size=32,batch_size=40, sequence_length=35)
